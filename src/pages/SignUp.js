    ...
    return(
        <React.Fragment>
            <Div flex_direction="column" align_items="felx-start" padding="0">
                ...
                <Input width="100%" max_width="289px" height="28px" placeholder="비밀번호" font_size="xxs" padding="0 10px" margin="0 10px 0 0"/>
                <P font_size = "xxs" padding="5px 0">비밀번호 확인</P>
                <Input width="100%" max_width="289px" height="28px" placeholder="비밀번호 확인" font_size="xxs" padding="0 10px" margin="0 10px 0 0"/>
            </Div>
        </React.Fragment>
    )
}
